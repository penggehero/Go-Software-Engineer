...
[![img](./images/160_example_1_1.png)](https://assets.leetcode.com/uploads/2018/12/13/160_example_1.png)
...
// 双指针
/*
对于第二种解法，要点在于将两个链表的右端对齐。一旦两个链表存在相交，由于长度已经对齐所以两个指针一定能交点处相遇。
假设：

链表 A 长度为 m = a + c （前段 a，公共段 c）
